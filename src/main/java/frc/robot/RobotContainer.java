...
import frc.robot.subsystems.Windmill.WindmillIOKraken;
...
// Windmill control
controller.a().whileTrue(Commands.run(() -> windmill.setVoltage(3), windmill));
controller.b().whileTrue(Commands.run(() -> windmill.setVoltage(-3), windmill));
